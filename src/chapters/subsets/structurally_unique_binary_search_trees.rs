...
/// the root of the tree. all smaller numbers will make up the left sub-tree and bigger
/// numbers will make up the right sub-tree. we will make recursive calls for the left
/// and right sub-trees
struct Solution;
